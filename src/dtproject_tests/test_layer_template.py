...
class TestLayerTemplate(unittest.TestCase):
    ...
    def test_layer_template_project_v1(self):
    ...
    def test_layer_template_project_v2(self):
    ...
    def test_layer_template_project_v3(self):
    ...
    def test_layer_template_project_v4(self):
